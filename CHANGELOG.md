...
- **`samples/poolboy`**: round-5 TCP remote poolboy — [`PoolWire`](samples/poolboy/src/main/kotlin/org/otpstudy/poolboy/PoolWire.kt), [`PooledWorker`](samples/poolboy/src/main/kotlin/org/otpstudy/poolboy/PooledWorker.kt), `ForwardCall` / token checkin, [`KotlinNodeTransport`](otp-distribution/src/main/kotlin/org/otpstudy/distribution/KotlinNodeTransport.kt) loopback tests (checkout, status, checkin, global). 33-test matrix.
